...
<body>
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
          <div class="site-heading">
            <h1>Clean Blog</h1>
            <hr class="small">
            <span class="subheading">A Clean Blog by lichongli</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-2 col-md-2" style="word-break:break-all;">
        <div>
          <div id='tag-cloud'>
            <h3>左侧导航栏</h3>
            <a href="<%=basePath %>category?category=Java">Java</a>
            <a href="<%=basePath %>category?category=C/C++">C/C++</a> <br/>
            <a href="<%=basePath %>category?category=Python">Python</a>
            <a href="<%=basePath %>category?category=OS">OS</a> <br/>
            <a href="<%=basePath %>category?category=网络">网络</a>
            <a href="<%=basePath %>category?category=框架">框架</a> <br/>
            <a href="<%=basePath %>category?category=生活">生活</a>
            <!--
      ...
      <div class="col-lg-8 col-md-10">
        ...
        <c:forEach var="blog" items="${blogs}">
          <div class="post-preview">
            <a href="<%=basePath %>blog?p=${blog.id}">
              <h2 class="post-title">
                  ${blog.title}
              </h2>
            </a>
        ...
        <ul class="pager">
          <li class="next">
            <a href="<%=basePath %>blog?p=0">More Blogs &rarr;</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="col-lg-12 col-md-12">
      <form action="<%=basePath %>message" method="post" onsubmit="return validate_message(this)">
