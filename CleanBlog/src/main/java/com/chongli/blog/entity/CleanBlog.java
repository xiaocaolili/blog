package com.chongli.blog.entity;
...
public class CleanBlog {
    ...
    public CleanBlog(String title, String text, String preview, String author, String category, String date) {
        this.title = title;
        this.text = text;
